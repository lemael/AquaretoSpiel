...
/**
 * This class stores all the data needed to apply and revert a addLargeExtension()-Invocation.
 *
...
class AddLargeExtensionCommand @JsonCreator constructor(
    id: Int,
    private val newTiles: List<Pair<Int, Int>>,
    private val player: Player,
    private val data: Pair<Int, Int>
): Command(id) {
    override fun apply() {
        player.park.largeExtensions.add(data)
        player.numCoins -= 2
    ...
    override fun revert() {
        player.park.largeExtensions.remove(data)
        player.numCoins += 2
